...
describe('posts', () => {
  ...
  scenario('creates a post', async () => {
    const result = await createPost({
      input: {
        updatedAt: '2023-02-09T19:43:16.460Z',
        title: 'String',
        body: 'String',
      },
    })

    expect(result.updatedAt).toEqual(new Date('2023-02-09T19:43:16.460Z'))
  ...
  scenario('updates a post', async (scenario: StandardScenario) => {
    ...
    const result = await updatePost({
      id: original.id,
      input: { updatedAt: '2023-02-10T19:43:16.460Z' },
    })

    expect(result.updatedAt).toEqual(new Date('2023-02-10T19:43:16.460Z'))
  })
